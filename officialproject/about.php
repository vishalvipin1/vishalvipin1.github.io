...
?>
    <header id='home' class='header'>
        ...
        <section>
        <div class='aboutus'>
            <h2 style='padding:30px;'>About Us</h2>
            <div class='aupara1'>
            <p class='para1'>Young, Fun and original, we provide a unique online retail experience around the world.
                Born in 2021, Vidwan have grown into a brand that evolved into the next stage of the company's journey
                and making Vidwan the local hub for clothing. With fast delivery, easy payemnt and return option and a 24-hour customer service, find everything you need at competititve prices.   
            </p>
            
            <div id='aupic2'>
            <img src='https://images.financialexpress.com/2019/12/online-shopping-trends-small.jpg' alt='aboutuspic1' id='aboutuspic1' style='height:200px; width:300px;'>
            </div>
            </div>
            <div class='aupara2'>
            <p class='para2'>We, at Vidwan, believe in sustainable change, and create positive impact towards the surroundings. We are commited to makign better decisions about our practices- 
                sourcing premium brands from around the world and reducing the environmental impact of each product.
            We strive to be bold, curious, innovative and inclusive to help build a better world for people and the planet.</p>
            
            <div id='aupic2'>
            <img src='https://www.greenbiz.com/sites/default/files/images/articles/featured/shutterstock_city_mr._high_sky_0.jpg', alt='aboutuspic2' id='aboutuspic2' style='height:200px; width:300px;'>   
            </div>
            </div>    
        </div>
        </section>
