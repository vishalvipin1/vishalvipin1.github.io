...
<?php
  ...
  if(isset($_SESSION['username'])){
    echo "<script>document.addEventListener('DOMContentLoaded',()=> {document.querySelector('.loginstatus .loginstatusblock').innerHTML='Hello {$_SESSION['username']}!<br><a href=logout.php>Logout</a>';});</script>";
        ...
        echo "<script>location.href='delivery.html';</script>";
...
?>
    <header id='home' class='header'>
        ...
        <div class='aboutus'>
            ...
            <div class='erp'>            
            <h4 class='subheading'>We deliver Products to all areas across India</h4>
            <p>As soon as the Payment process is completed, your Delivery will be Processed. A Receipt will be Generated at the end of the Payment, mentioning all the details about the Mode of Payment used,
            Delivery Address, Personal details, Delivery Date, etc. </p>
            <p>Your Orders will be delivered within 1-4 days, depending on the area.</p><br>
            <p>If you wasn't available at the time of delivery of Product, the Product will be shipped back to the nearest Vidwan Office and can be collected.<br>
            Make sure to bring your Receipt undamaged, for Validation Purpose and Security Reasons; and your Product will be handed over to You.<br>
            Please wait for an Email and/or SMS from us telling you when its ready to collect.</p><br>
            <p>We keep your order in Vidwan office for 7 Business Days.<br>
                All uncollected order will be Cancelled, and any Payments made will be Refunded to the card used for Purchase.</p><br>
            <p><b>Delivery Option</b>:
                <ol>
                    <li>Home Delivery: Non-Members- INR 65; Members- Free (Depending on the Location).</li>
                    <li>Collect From Office- Free.</li>
                </ol>
            </p>
            </div>
        </div>
